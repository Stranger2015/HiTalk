...
/**
 * HiTalkWAMInstruction provides a structured in-memory representation of the WAM instruction set, as well as utilities to
 * emit the instructions as byte code, disassemble them back into the structured representation, and pretty print them.
 * <p>
 ...
 */
public
class HiTalkWAMInstruction implements Sizeable {
    /**
     ...
     *
     */
    public static final byte EXTENDS = CALL_INTERNAL + 1;

    /**
     *
     */
    public static final byte IMPLEMENTS = CALL_INTERNAL + 2;

    /**
     *
     */
    public static final byte IMPORTS = CALL_INTERNAL + 3;

    /**
     *
     */
    public static final byte CALL_EAGER = CALL_INTERNAL + 4;

    /**
     *
     */
    public static final byte EXECUTE_EAGER = CALL_INTERNAL + 5;

    /**
     *
     */
    public static final byte CALL_LAZY = CALL_INTERNAL + 6;

    /**
     *
     */
    public static final byte EXECUTE_LAZY = CALL_INTERNAL + 7;

    public static final byte ALLOCATE_CUR_CTX = CALL_INTERNAL + 8;

    public static final byte ALLOCATE_LOC_CTX = CALL_INTERNAL + 9;

    public static final byte ALLOCATE_LAST_CUR_CTX = CALL_INTERNAL + 10;
    public static final byte ALLOCATE_LAST_LOC_CTX = CALL_INTERNAL + 11;

    public static final byte DEALLOCATE_CTX = CALL_INTERNAL + 12;
    public static final byte DEALLOCATE_LAST_CTX = CALL_INTERNAL + 13;
     ...
     * The instruction.
     */
    protected HiTalkWAMInstructionSet mnemonic;
    /**
     ...
     */
    public
    HiTalkWAMInstruction ( HiTalkWAMInstructionSet mnemonic ) {
     ...
     */
    public
    HiTalkWAMInstruction ( byte code ) {
        this.mnemonic = HiTalkWAMInstructionSet.fromCode(code);
    }
     ...
     */
    public
    HiTalkWAMInstruction ( HiTalkWAMInstructionSet mnemonic, byte mode1, byte reg1, byte reg2 ) {
        this.mnemonic = mnemonic;
        this.mode1 = mode1;
        this.reg1 = reg1;
        this.reg2 = reg2;
     ...
     */
    public
    HiTalkWAMInstruction ( HiTalkWAMInstructionSet mnemonic, byte mode1, byte reg1 ) {
        this.mnemonic = mnemonic;
        this.mode1 = mode1;
        this.reg1 = reg1;
    }
     ...
     */
    public
    HiTalkWAMInstruction ( HiTalkWAMInstructionSet mnemonic, byte reg1 ) {
        this.mnemonic = mnemonic;
        this.reg1 = reg1;
    }
    ...
    SizeableList <HiTalkWAMInstruction> disassemble ( int start, int length, ByteBuffer codeBuf, VariableAndFunctorInterner interner, WAMCodeView codeView ) {
        ...
        while (ip < (start + length)) {
            ...
            HiTalkWAMInstruction instruction = new HiTalkWAMInstruction(iCode);
     ...
     */
    public
    HiTalkWAMInstructionSet getMnemonic () {
        return mnemonic;
    }
     ...
     */
    public
    void emitCode ( ByteBuffer codeBuffer, HiTalkWAMMachine machine ) throws LinkageException {
        mnemonic.emitCode(this, codeBuffer, machine);
    }
    ...
    enum HiTalkWAMInstructionSet {
        ...
        PutVar(PUT_VAR, "put_var", 4, 0x7) {
            ...
            public
            void emitCode ( HiTalkWAMInstruction instruction, ByteBuffer codeBuf, HiTalkWAMMachine machine ) {
                emitCodeReg1Reg2(codeBuf, code, instruction);
            }
        ...
        PutConstant(PUT_CONST, "put_const", 7, 0xb) {
            ...
            /** {@inheritDoc} */
            public
            void emitCode ( HiTalkWAMInstruction instruction, ByteBuffer codeBuf, HiTalkWAMMachine machine ) throws LinkageException {
                emitCodeReg1Fn(codeBuf, code, instruction, machine);
            }
        ...
        SetConstant(SET_CONST, "set_const", 5, 0x8) {
            ...
            public
            void emitCode ( HiTalkWAMInstruction instruction, ByteBuffer codeBuf, HiTalkWAMMachine machine ) throws LinkageException {
                emitCodeFn(codeBuf, code, instruction, machine);
            }
        ...
        SetVoid(SET_VOID, "set_void", 2, 0x2) {
            ...
            public
            void emitCode ( HiTalkWAMInstruction instruction, ByteBuffer codeBuf, HiTalkWAMMachine machine ) {
                emitCodeReg1NoMode(codeBuf, code, instruction);
            }
        ...
        Call(CALL, "call", 7, 0xa) {
            ...
            void emitCode ( HiTalkWAMInstruction instruction, ByteBuffer codeBuf, HiTalkWAMMachine machine ) throws LinkageException {
                ...
                if (callPointToCall == null) {
                    throw new LinkageException("Could not resolve call to " + instruction.fn + ".", null, null, "Unable to resolve call to " + instruction.fn.getName() + "/" + instruction.fn.getArity() + ".");
                }
            ...
            public
            String toString ( HiTalkWAMInstruction instruction ) {
                return pretty + " " + ((instruction.fn != null) ? (instruction.fn.getName() + "/" + instruction.fn.getArity()) : "") + (", " + instruction.reg1);
            }
        },
        ...
        Execute(EXECUTE, "execute", 6, 0x8) {
            ...
            public
            String toString ( HiTalkWAMInstruction instruction ) {
                return pretty + " " + ((instruction.fn != null) ? (instruction.fn.getName() + "/" + instruction.fn.getArity()) : "");
            }
        },
        ...
        SwitchOnTerm(SWITCH_ON_TERM, "switch_on_term", 17, 0x0) {
            ...
            public
            String toString ( HiTalkWAMInstruction instruction ) {
                return pretty + " " + labelToString(instruction.target1) + " / " + labelToString(instruction.target2) + " / " + labelToString(instruction.target3) + " / " + labelToString(instruction.target4);
            }
        },
        ...
        CallInternal(CALL_INTERNAL, "call_internal", 7, 0xa) {
            ...
            void emitCode ( HiTalkWAMInstruction instruction, ByteBuffer codeBuf, HiTalkWAMMachine machine ) throws LinkageException {
                ...
                // Ensure that a valid call point was returned, otherwise a linkage error has occurred.
                if (callPointToCall == null) {
                    throw new LinkageException("Could not resolve internal call to " + instruction.fn + ".", null, null, "Unable to resolve internal call to " + instruction.fn.getName() + "/" + instruction.fn.getArity() + ".");
                }
         ...
         *
         */
        Extends(EXTENDS, "$extends", 1 + 4, 0) {

        },

        Implements(IMPLEMENTS, "$implements", 5, -1) {
        ...
        ExecuteEager(EXECUTE_EAGER, "execute_eager", 2, -555) {

        },
        CallLazy(CALL_LAZY, "call_lazy", 2, -555) {

        },
        ExecuteLazy(EXECUTE_LAZY, "execute_lazy", 2, -555) {

        },
        AllocateCurCtx(ALLOCATE_CUR_CTX, "allocate_cur_ctx", 2, -555) {

        },
        AllocateLocCtx(ALLOCATE_LOC_CTX, "allocate_loc_ctx", 2, -555) {

        },
        AllocateLastCurCtx(ALLOCATE_LAST_CUR_CTX, "allocate_last_cur_ctx", 2, -555) {

        },
        AllocateLastLocCtx(ALLOCATE_LAST_LOC_CTX, "allocate_last_loc_ctx", 2, -555) {

        },
        DeallocateCtx(DEALLOCATE_CTX, "deallocate_ctx", 2, -555) {

        },
        DeallocateLastCtx(DEALLOCATE_LAST_CTX, "deallocate_last_ctx", 2, -555) {
         ...
         */
        private static final Map <Byte, HiTalkWAMInstructionSet> codeToValue = new HashMap <>();

        static {
            for (HiTalkWAMInstructionSet instruction : EnumSet.allOf(HiTalkWAMInstructionSet.class)) {
         ...
         * <tr><th> Bit <th> Field
         * <tr><td>  0  <td> {@link HiTalkWAMInstruction#mode1}
         * <tr><td>  1  <td> {@link HiTalkWAMInstruction#reg1}
         * <tr><td>  2  <td> {@link HiTalkWAMInstruction#reg2}
         * <tr><td>  3  <td> {@link HiTalkWAMInstruction#fn}
         * <tr><td>  4  <td> {@link HiTalkWAMInstruction#target1}
         * </table></pre>
         */
         ...
         */
        HiTalkWAMInstructionSet ( byte i, String pretty, int length, int fieldMask ) {
            this.code = i;
            this.pretty = pretty;
            this.length = length;
         ...
         */
        public static
        HiTalkWAMInstructionSet fromCode ( byte code ) {
            return codeToValue.get(code);
        }

        /**
         * Provides the CALL_INTERNAL name of register 1, "X" for register addressing, "Y" for stack mode addressing.
         *
         * @param instruction The instruction to get the CALL_INTERNAL register name from;
         * @return The CALL_INTERNAL name of register 1, "X" for register addressing, "Y" for stack mode addressing.
         */
        public static
        String reg1Name ( HiTalkWAMInstruction instruction ) {
         ...
         */
        private static
        void emitCodeReg1 ( ByteBuffer codeBuf, byte code, HiTalkWAMInstruction instruction ) {
            codeBuf.put(code);
         ...
         */
        private static
        void emitCodeReg1NoMode ( ByteBuffer codeBuf, byte code, HiTalkWAMInstruction instruction ) {
            codeBuf.put(code);
            codeBuf.put(instruction.reg1);
        }
         ...
         */
        private static
        void emitCodeReg1Reg2 ( ByteBuffer codeBuf, byte code, HiTalkWAMInstruction instruction ) {
            codeBuf.put(code);
            codeBuf.put(instruction.mode1);
            codeBuf.put(instruction.reg1);
         ...
         */
        private static
        String toStringReg1 ( String pretty, HiTalkWAMInstruction instruction ) {
         ...
         */
        private static
        String toStringReg1Reg2 ( String pretty, HiTalkWAMInstruction instruction ) {
         ...
         */
        private static
        String toStringReg1Fn ( String pretty, HiTalkWAMInstruction instruction ) {
            return pretty + " " + ((instruction.fn != null) ? (instruction.fn.getName() + "/" + instruction.fn.getArity()) : "") + ", A" + instruction.reg1;
        }
         ...
         */
        private static
        String toStringFn ( String pretty, HiTalkWAMInstruction instruction ) {
            return pretty + " " + ((instruction.fn != null) ? (instruction.fn.getName() + "/" + instruction.fn.getArity()) : "");
        }
         ...
         */
        private static
        void disassembleReg1 ( ByteBuffer codeBuf, int ip, HiTalkWAMInstruction instruction ) {
            instruction.mode1 = codeBuf.get(ip + 1);
            instruction.reg1 = codeBuf.get(ip + 2);
        }
         ...
         */
        private static
        void disassembleReg1NoMode ( ByteBuffer codeBuf, int ip, HiTalkWAMInstruction instruction ) {
         ...
         */
        private static
        void disassembleReg1Reg2 ( ByteBuffer codeBuf, int ip, HiTalkWAMInstruction instruction ) {
            instruction.mode1 = codeBuf.get(ip + 1);
            instruction.reg1 = codeBuf.get(ip + 2);
        ...
        public
        void emitCode ( HiTalkWAMInstruction instruction, ByteBuffer codeBuf, HiTalkWAMMachine machine ) throws LinkageException {
            emitCodeReg1(codeBuf, code, instruction);
        }
