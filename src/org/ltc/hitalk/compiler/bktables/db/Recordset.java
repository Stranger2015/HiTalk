 ...
 */
public
class Recordset<R extends Record> implements Set <R> {
    ...
    <T> T[] toArray ( @NotNull T[] a ) {
        return (T[]) records.toArray(new Object[records.size()]);
    }
     ...
     *
     * @param r element to be added to this set
    ...
    @Override
    public
    boolean addAll ( @NotNull Collection <? extends R> c ) {
