 ...
 */
public abstract
class LogtalkFlag extends Flag {
    ...
    static
    class UnknownEntities extends LogtalkFlag {
    ...
    static
    class Portability extends LogtalkFlag {
        public static final String WARNING = "warning";
        public static final String SILENT = "silent";
    ...
    static
    class UnderscoreVariables extends LogtalkFlag {
    ...
    static
    class Complements extends LogtalkFlag {
    ...
    static
    class DynamicDeclarations extends LogtalkFlag {
        public static final String ALLOW = "allow";
        public static final String DENY = "deny";
    ...
    static
    class Events extends LogtalkFlag {
        public static final String ALLOW = "allow";
        public static final String DENY = "deny";
    ...
    static
    class ContextSwitchingCalls extends LogtalkFlag {
        public static final String ALLOW = "allow";
        public static final String DENY = "deny";

        public
        ContextSwitchingCalls () {
    ...
    static
    class Report extends LogtalkFlag {
    ...
    static
    class Optimize extends LogtalkFlag {
        public static final String ON = "on";
        public static final String OFF = "off";
    ...
    public static
    class Hook extends LogtalkFlag {
    ...
    static
    class Clean extends LogtalkFlag {
        public static final String ON = "on";
        public static final String OFF = "off";
