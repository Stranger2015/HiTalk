...
class HiTalkParser extends HiLogParser {
    ...
    private static final java.util.logging.Logger console = java.util.logging.Logger.getLogger("CONSOLE." + PrologParser.class.getName());
...
//        try
//        {
//         //   CharStream inputStream = new SimpleCharStream(System.in, null, 1, 1);
