...
public abstract
class BaseFileSystem<T extends Path, P extends FileSystemProvider> extends FileSystem {

    private final P fileSystemProvider;

    public
    BaseFileSystem ( P fileSystemProvider ) {
    ...
    @Override
    public
    T getPath ( String first, String... more ) {
    ...
    protected
    void appendDedupSep ( StringBuilder sb, CharSequence s ) {
    ...
    T create ( String root, Collection <String> names ) {
        return create(root, new org.ltc.hitalk.org.apache.nio.ImmutableList <>(names.toArray(new String[names.size()])));
    }

    protected abstract
    T create ( String root, org.ltc.hitalk.org.apache.nio.ImmutableList <String> names );

    protected
    T create ( String root, String... names ) {
        return create(root, new org.ltc.hitalk.org.apache.nio.ImmutableList <>(names));
    }
