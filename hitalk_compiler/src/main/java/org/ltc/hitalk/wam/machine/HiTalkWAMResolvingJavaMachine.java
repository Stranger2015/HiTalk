  ...
  import static com.thesett.aima.logic.fol.wam.compiler.WAMInstruction.*;
   ...
   */
  public
  class HiTalkWAMResolvingJavaMachine<PC extends HiTalkWAMCompiledPredicate,
       ...
       */
      protected HiTalkWAMResolvingJavaMachine(ISymbolTable<Integer, String, Object> symbolTable) {
          super(symbolTable);
      }
       ...
       *                          the existence of clauses which are not in the domain. Implementations may elect to raise
      ...
      public Iterator<Set<HtVariable>> iterator() {
          return new SequenceIterator<Set<HtVariable>>() {
              public Set<HtVariable> nextInSequence() {
                  return resolve();
              }
          };
      }
