...
public enum Language {
    PROLOG("Prolog", new PlPrologParser(), new PrologWAMCompiler <>()),
    HITALK("HiTalk", new HiTalkParser(), new HiTalkWAMCompiler()),
    HILOG("HiLog", new HiLogParser(), new HiLogWAMCompiler <>()),
    LOGTALK("Logtalk", new LogtalkParser(), new LogtalkWAMCompiler());
