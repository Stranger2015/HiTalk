...
public class TermWriter extends PrintWriter
{
	...
	protected void displayTerm(WriteOptions options, int priority, Term term)
	{
		...
		else if (term instanceof org.ltc.hitalk.gnu.prolog.term.IntegerTerm)
		{
	...
	protected void displayCompound(WriteOptions options, int priority, CompoundTerm term)
	{
		...
		if (options.numbervars && term.tag == numbervarsTag && term.args[0] instanceof org.ltc.hitalk.gnu.prolog.term.IntegerTerm)
		{
	 ...
	 */
	protected void displayInteger(WriteOptions options,org.ltc.hitalk.gnu.prolog.term.IntegerTerm term)
	{
		print(term.value);
	}
