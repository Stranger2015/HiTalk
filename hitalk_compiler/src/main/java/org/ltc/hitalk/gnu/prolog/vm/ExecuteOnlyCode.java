...
public abstract class ExecuteOnlyCode implements PrologCode {
    ...
    public abstract Result execute(Interpreter interpreter, boolean backtrackMode, Term[] args)
            throws Exception;

    /**
     * Just an empty method as we don't need to do anything here.
     *
     * @see Installable#install(Environment)
     */
     ...
     * Just an empty method as we don't need to do anything here.
     *
     * @seeorg.ltc.hitalk.gnu.prolog.vm.Installable#uninstall(gnu.prolog.vm.Environment)
     */
