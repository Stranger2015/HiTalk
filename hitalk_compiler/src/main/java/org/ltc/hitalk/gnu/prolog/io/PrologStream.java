...
import org.ltc.hitalk.gnu.prolog.term.JavaObjectTerm;
...
public abstract class PrologStream
{
	...
	public static final org.ltc.hitalk.gnu.prolog.term.CompoundTermTag filenameTag =org.ltc.hitalk.gnu.prolog.term.CompoundTermTag.get("file_name", 1);
	public static final org.ltc.hitalk.gnu.prolog.term.CompoundTermTag modeTag =org.ltc.hitalk.gnu.prolog.term.CompoundTermTag.get("mode", 1);
	public static final org.ltc.hitalk.gnu.prolog.term.CompoundTermTag aliasTag =org.ltc.hitalk.gnu.prolog.term.CompoundTermTag.get("alias", 1);
	public static final org.ltc.hitalk.gnu.prolog.term.CompoundTermTag positionTag =org.ltc.hitalk.gnu.prolog.term.CompoundTermTag.get("position", 1);
	public static final org.ltc.hitalk.gnu.prolog.term.CompoundTermTag endOfStreamTag =org.ltc.hitalk.gnu.prolog.term.CompoundTermTag.get("end_of_stream", 1);
	public static final org.ltc.hitalk.gnu.prolog.term.CompoundTermTag eofActionTag =org.ltc.hitalk.gnu.prolog.term.CompoundTermTag.get("eof_action", 1);
	public static final org.ltc.hitalk.gnu.prolog.term.CompoundTermTag repositionTag =org.ltc.hitalk.gnu.prolog.term.CompoundTermTag.get("reposition", 1);
	public static final org.ltc.hitalk.gnu.prolog.term.CompoundTermTag typeTag =org.ltc.hitalk.gnu.prolog.term.CompoundTermTag.get("type", 1);
	...
	public abstract Term readTerm(Term streamTerm, Interpreter interpreter,ReadOptions options) throws Exception;
