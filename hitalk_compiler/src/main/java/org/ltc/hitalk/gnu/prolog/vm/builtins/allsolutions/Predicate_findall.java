...
public class Predicate_findall extends ExecuteOnlyCode
{
			...
			throws PrologException
	{
		...
		checkList(args[2]);
		Result rc = findall(interpreter, backtrackMode, args[0], args[1], list);
		if (rc == SUCCESS_LAST)
		{
	 ...
	 * @throws PrologException
	 */
	public static Result findall(Interpreter interpreter, boolean backtrackMode, Term template, Term goal, List<Term> list)
			throws PrologException
	{
