...
import static org.ltc.hitalk.gnu.prolog.database.Predicate.TYPE.BUILT_IN;
import static org.ltc.hitalk.gnu.prolog.io.Operator.SPECIFIER.NONE;
import static org.ltc.hitalk.gnu.prolog.io.Operator.SPECIFIER.fromAtom;
 ...
 *      {@link Environment Environment} use the same instance of
...
public class PrologTextLoader
{
	...
	protected void processOpDirective(Term priority, Term specifier, Term operatorAtom)
	{
		...
		SPECIFIER spec = fromAtom(specifierAtom);
		if (spec == NONE)
		{
