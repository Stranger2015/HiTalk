...
import static org.ltc.hitalk.gnu.prolog.vm.PrologException.existenceError;
import static org.ltc.hitalk.gnu.prolog.vm.PrologException.systemErrorAtom;
import static org.ltc.hitalk.gnu.prolog.vm.TermConstants.failAtom;
...
public class UndefinedPredicateCode extends ExecuteOnlyCode {
    ...
    public Result execute(Interpreter interpreter, boolean backtrackMode, Term[] args)
        ...
        if (flg == errorAtom) {
            ...
            existenceError(procedureAtom, predicateIndicator);
        ...
        throw new PrologException(systemErrorAtom, null);
    }
}
