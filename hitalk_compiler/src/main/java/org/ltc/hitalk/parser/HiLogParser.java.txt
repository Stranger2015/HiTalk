 ...
 */
public
class HiLogParser<T extends HtClause> extends HtPrologParser <T> {
...
//    protected static final ListTerm NIL = new ListTerm(new Term[0]);//fixme
    ...
    Term listFunctor ( int delim ) throws SourceCodeException { //fixme
        ...
        Token leftDelim = consumeToken((delim == RBRACKET) ? LBRACKET : LPAREN);
        ...
        Token rightDelim = consumeToken(RBRACKET);
