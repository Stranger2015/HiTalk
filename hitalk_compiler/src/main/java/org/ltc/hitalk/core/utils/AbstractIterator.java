...
// portable iterator and enumeration implementation.
 ...
 * Typical usage:
 * <pre>
 *     {@link Vector Vector} v = new {@link Vector() Vector};
 *     String s = "target";
 *     ...
 ...
 * </pre>
 * <p>
 * Users of Java's <code>Enumeration</co be taken to make sure that the underlying data
...
public abstract class AbstractIterator<E> implements Enumeration <E>, Iterator <E>, Iterable <E> {
     ...
     */
    public void remove () {
        Assert.error("Remove not implemented.");
    }
